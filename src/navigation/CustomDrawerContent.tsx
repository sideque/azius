...
export function CustomDrawerContent(props: any) {
  ...
  return (
    <DrawerContentScrollView {...props} style={{ backgroundColor: colors.background }}>
      ...
      />
      <DrawerItem label="Logout" onPress={goToLogin} labelStyle={{ color: colors.error }} />
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 56, height: 56, borderRadius: 28, backgroundColor: 'rgba(255,255,255,0.2)', textAlign: 'center', lineHeight: 56, fontSize: 24, fontWeight: '700', color: '#fff', overflow: 'hidden' },
