...
const styles = StyleSheet.create({
  ...
  section: { fontSize: 18, fontWeight: '700', marginTop: 8, marginBottom: 12 },
  card: { borderRadius: 12, padding: 16, borderWidth: 1, marginBottom: 8 },
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderRadius: 12, borderWidth: 1, marginBottom: 8 },
});
